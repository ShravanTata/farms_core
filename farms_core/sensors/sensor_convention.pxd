...
cdef enum:
    ...
    MUSCLE_FORCE_LENGTH = 8
    MUSCLE_FORCE_VELOCITY = 9
    MUSCLE_ACTIVE_FORCE = 10
    MUSCLE_PASSIVE_FORCE = 11
    # TENDON
    MUSCLE_TENDON_LENGTH = 12
    MUSCLE_TENDON_FORCE = 13
    # FEEDBACKS
    MUSCLE_IA_FEEDBACK = 14
    MUSCLE_II_FEEDBACK = 15
    MUSCLE_IB_FEEDBACK = 16
